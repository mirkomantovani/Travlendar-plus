...
ALTER TABLE Break ADD CONSTRAINT PK_Break PRIMARY KEY (UID,BREAKID);

CREATE TABLE Warning (
 UID INT NOT NULL,
 WARNINGID INT NOT NULL,
 meetings VARCHAR(255),
 breaks VARCHAR(255)
);

ALTER TABLE Warning ADD CONSTRAINT PK_Warning PRIMARY KEY (UID,WARNINGID);
...
ALTER TABLE TravelMean ADD CONSTRAINT FK_TravelMean_0 FOREIGN KEY (UID) REFERENCES Usertable (UID);


ALTER TABLE Break ADD CONSTRAINT FK_Break_0 FOREIGN KEY (UID) REFERENCES Usertable (UID);

ALTER TABLE Warning ADD CONSTRAINT FK_Warning_0 FOREIGN KEY (UID) REFERENCES Usertable (UID);
